...
export const BgImage = () => {
  return (
    <div
      className="0.5xl:-mx-[86px] relative -mx-2 h-[400px] bg-cover bg-center md:h-[617px] lg:bg-[center_37%]"
      style={{ backgroundImage: `url(${imagePath("images/home-bg.jpg")})` }}
    >
      <Gradient />
      <div className="0.5xl:ml-[86px] relative z-10 ml-4 flex h-full flex-col pt-4 md:pt-8">
        ...
        <div className="flex h-full flex-col items-center justify-between pb-4 lg:my-auto lg:h-fit lg:items-start lg:gap-9">
          ...
          <ul className="lg:max-w-1.5xl px-4 pl-10 md:max-w-[660px] lg:list-disc lg:pr-0">
